...
struct parameters_t {
    ...
    std::string outfile= "queryResults.tsv";
};
...
void parse_arguments(int argc, char **argv, parameters_t & params)
{
    ...
    TCLAP::UnlabeledValueArg<std::string> kmer_filename_arg("kmers", ".fasta file of kmers to query.", true, "", "kmer file", cmd);
...
int main(int argc, char* argv[]) {
    ...
    //TODO track size and memory in output file
